...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"> PartPlaceEncoder	</h1>
</div>
    ...
    if($_FILES["file"]["size"] > 0){
        ...
        while(($column = fgetcsv($file, 10006, ",")) !== FALSE){
            ...
            if (isset($column[0]) && isset($column[1]) && isset($column[2]) && isset($column[3]) && isset($column[4]) && isset($column[5])) {
                ...
                $sqlInsert = "INSERT INTO PartPlaceEncoder	 (PartPlaceEncoder	,Timestamp) VALUES ( '" . $column[33] . "','" . $column[9] . "')";
...
if(isset($_POST["delete"])){
    $sqlDelete = "DELETE FROM PartPlaceEncoder	";
...
try {
    ...
    $sql = "SELECT Timestamp,PartPlaceEncoder	 FROM PartPlaceEncoder	 ";
