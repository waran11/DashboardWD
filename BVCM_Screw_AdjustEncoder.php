...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"> BVCM Screw AdjustEncoder</h1>
</div>
    ...
    if($_FILES["file"]["size"] > 0){
        ...
        while(($column = fgetcsv($file, 10006, ",")) !== FALSE){
            ...
            if (isset($column[0]) && isset($column[1]) && isset($column[2]) && isset($column[3]) && isset($column[4]) && isset($column[5])) {
                ...
                $sqlInsert = "INSERT INTO bvcm_screw_adjustencoder (bvcm_screw_adjustencoder,Timestamp) VALUES ( '" . $column[30] . "','" . $column[9] . "')";
...
if(isset($_POST["delete"])){
    $sqlDelete = "DELETE FROM bvcm_screw_adjustencoder";
...
try {
    ...
    $sql = "SELECT Timestamp,bvcm_screw_adjustencoder FROM bvcm_screw_adjustencoder ";
    ...
    foreach ($chartData as $row) {
        ...
        $data[] = $row['bvcm_screw_adjustencoder'];
    }
} catch(PDOException $e) {
    echo "Connection failed: " . $e->getMessage();
}
...
<body>
    ...
    <script>
        ...
        var chartData = {
            ...
            datasets: [{
                label: 'bvcm_screw_adjustencoder',
