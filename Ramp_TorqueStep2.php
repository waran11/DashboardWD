...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"> Ramp Torque Step2	</h1>
</div>
    ...
    if($_FILES["file"]["size"] > 0){
        ...
        while(($column = fgetcsv($file, 10006, ",")) !== FALSE){
            ...
            if (isset($column[0]) && isset($column[1]) && isset($column[2]) && isset($column[3]) && isset($column[4]) && isset($column[5])) {
                ...
                $sqlInsert = "INSERT INTO Ramp_TorqueStep2	 (Ramp_TorqueStep2	,Timestamp) VALUES ( '" . $column[55] . "','" . $column[9] . "')";
...
if(isset($_POST["delete"])){
    $sqlDelete = "DELETE FROM Ramp_TorqueStep2	";
...
try {
    ...
    $sql = "SELECT Timestamp,Ramp_TorqueStep2	 FROM Ramp_TorqueStep2	 ";
